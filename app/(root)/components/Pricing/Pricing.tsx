              ...
              <CardHeader className="text-center pb-4">
                ...
                <CardContent className="mt-6">
                  ...
                  <Button
                    ...
                    size="lg"
                    className={`w-full font-semibold ${plan.popular ? "bg-indigo-500 hover:bg-indigo-600 text-white shadow-md" : "bg-purple-600/30 hover:bg-purple-700/50 text-white border border-purple-400/20"}`}
